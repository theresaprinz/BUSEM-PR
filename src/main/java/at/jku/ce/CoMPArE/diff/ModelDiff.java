        ...
        for (Subject s : source.getSubjects()) {
            if (!dest.getSubjects().contains(s)) {
                ...
                for (Message m : s.getExpectedMessages()) {
                    if (!destSubject.getExpectedMessages().contains(m))
                        removedExpectedMessages.add(new MessageBuffer(s, m));
                }
                ...
                for (Message m : s.getProvidedMessages()) {
                    if (!destSubject.getProvidedMessages().contains(m))
                        removedProvidedMessages.add(new MessageBuffer(s, m));
                }
