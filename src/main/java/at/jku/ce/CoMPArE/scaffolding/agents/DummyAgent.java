...
public class DummyAgent extends ScaffoldingAgent {
    ...
    public void updateScaffolds(Instance currentInstance, State finishedState) {
        ...
        for (int i = 0; i < r.nextInt(20); i++) {
            ...
            if (i % 2 == 0)
                sg.addScaffold(Scaffold.TYPE_METACOGNITIVE, new ExpandingScaffold("This is my metacognitive scaffold " + i, "This is the <b>detailed</b> description", this, "DuA" + i));
            if (i % 3 == 0)
                sg.addScaffold(Scaffold.TYPE_STRATEGIC, new ExpandingScaffold("This is my strategic scaffold " + i, "This is the <b>detailed</b> description", this, "DuA" + i));
            if (i % 5 == 0)
                sg.addScaffold(Scaffold.TYPE_PROCEDURAL, new ExpandingScaffold("This is my procedural scaffold " + i, "This is the <b>detailed</b> description", this, "DuA" + i));
