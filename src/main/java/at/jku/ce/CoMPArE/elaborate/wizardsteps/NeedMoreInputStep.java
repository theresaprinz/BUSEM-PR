    ...
    public NeedMoreInputStep(Wizard owner, Subject s, Instance i) {
        ...
        inputField.addValueChangeListener(e -> {
            ...
            if (step != null) {
                ...
                if (selectedItem.equals(optionSystem))
                    step = new AskForSystemStep(owner, inputField.getValue(), subject, instance);
                if (selectedItem.equals(optionSomebodyElse))
                    step = new AskForNewSenderSubjectStep(owner, inputField.getValue(), subject, instance);
                addNextStep(step);
            }
        });
